...
proto.VoiceAssistantRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    useVad: jspb.Message.getBooleanFieldWithDefault(msg, 3, false)
  };
...
/**
 * optional bool use_vad = 3;
 * @return {boolean}
 */
proto.VoiceAssistantRequest.prototype.getUseVad = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 3, false));
};
 ...
 * @return {!proto.VoiceAssistantRequest} returns this
 */
proto.VoiceAssistantRequest.prototype.setUseVad = function(value) {
  return jspb.Message.setProto3BooleanField(this, 3, value);
};
